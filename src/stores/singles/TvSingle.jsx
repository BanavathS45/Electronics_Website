      ...
      <div className="singleCard">
        ...
        <div className="row ">
          <div className="col-3 imgCard  ">
            ...
            <div className="smallImg">
              <div className="row">
                <div className="col">
                  {" "}
                  <img src={tvData[1].image} alt="" />
                </div>
                <div className="col">
                  {" "}
                  <img src={tvData[2].image} alt="" />
                </div>
                <div className="col">
                  {" "}
                  <img src={tvData[3].image} alt="" />
                </div>
                <div className="col">
                  {" "}
                  <img src={tvData[4].image} alt="" />
                </div>
              </div>
            </div>
          </div>
          <div className=" col productDetails">
              ...
              return (
                <label key={index + 1}>
                  ...
                  <FontAwesomeIcon
                    icon={faStar}
                    color={
                      currentRate <= (rateColor || rating) ? "yellow" : "gray"
                    }
                  />
                  {/* <faStar/> */}
                </label>
            ...
            <button
              className=" Added mt-3 btn btn-success"
              onClick={() => {
